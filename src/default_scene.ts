...
export default class default_scene extends Scene {
    ...
    // the scene begins
    loadScene(): void {
        // WE ARE NOT USING TILEMAPS IN THIS GAME, BUT IF WE WERE WE MIGHT DO SOMETHING LIKE THIS
        // this.load.tilemap("map", "game_assets/tilemaps/tys.json");
    }
    ...
    updateScene(deltaT: number): void {
       /*
        Again, we are not using tilemaps in this game, but if we were we could update it
